...
"""
        ...
        llm = get_default_model()
        response = llm.invoke([HumanMessage(content=prompt)], stream_mode="updates")
...
class SQLGeneratorAgent:
    ...
    def __init__(self):
        ...
        self.tools = [generate_sql_query, explain_sql_query]
...
# pylint: disable  My80OmFIVnBZMlhrdUp2bG43bmx2TG82VDFsVGJ3PT06NDE0MmMzNDI=
