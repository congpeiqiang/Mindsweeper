...
# pragma: no cover  MS80OmFIVnBZMlhrdUp2bG43bmx2TG82VDBWWGF3PT06M2JlMmUxMTk=
...
# fmt: off  My80OmFIVnBZMlhrdUp2bG43bmx2TG82VDBWWGF3PT06M2JlMmUxMTk=
...
def ensure_db_connection() -> bool:
    ...
    if not db_manager.validate_connection():
        ...
        connect_state = db_manager.connect(config)
        print(f"数据库连接状态: {connect_state}\n 数据库信息: {config}")
